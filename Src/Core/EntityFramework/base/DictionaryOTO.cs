...
namespace EntityFramework
{
    ...
    public class DictionaryOTO<TFirst, TSecond>
    {
        IDictionary<TFirst, TSecond> firstToSecond = new Dictionary<TFirst, TSecond>();
        IDictionary<TSecond, TFirst> secondToFirst = new Dictionary<TSecond, TFirst>();

        public List<TFirst> KeysByFirst { get { return firstToSecond.Keys.ToList(); } }
        public List<TSecond> KeysBySecond { get { return secondToFirst.Keys.ToList(); } }
        public List<TSecond> ValuesByFirst { get { return firstToSecond.Values.ToList(); } }
        public List<TFirst> ValuesBySecond { get { return secondToFirst.Values.ToList(); } }
